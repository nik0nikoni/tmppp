'''
класс не создаёт конкретные объекты напрямую, а делегирует их создание специальному методу.

Creator содержит общую логику

ConcreteCreator решает какой объект создать
'''
